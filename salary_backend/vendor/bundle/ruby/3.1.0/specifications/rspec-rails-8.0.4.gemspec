...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<rspec-core>.freeze, [">= 3.13.0", "< 5.0.0"])
    s.add_dependency(%q<rspec-expectations>.freeze, [">= 3.13.0", "< 5.0.0"])
    s.add_dependency(%q<rspec-mocks>.freeze, [">= 3.13.0", "< 5.0.0"])
    s.add_dependency(%q<rspec-support>.freeze, [">= 3.13.0", "< 5.0.0"])
